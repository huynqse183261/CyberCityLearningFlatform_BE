...
namespace CyberCity.Controller.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCourses([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, [FromQuery] string level = null, [FromQuery] bool descending = true)
        {
            ...
            var mapped = new PagedResult<CourseListItemDto>
            {
                Items = result.Items.Select(c => _mapper.Map<CourseListItemDto>(c)).ToList(),
        ...
        public async Task<IActionResult> Create([FromBody] CourseCreateUpdateDto request)
        {
            ...
            return CreatedAtAction(nameof(GetById), new { id = uid }, _mapper.Map<CourseDetailDto>(created));
        }
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] CourseCreateUpdateDto request)
        {
            ...
            return Ok(_mapper.Map<CourseDetailDto>(updated));
        }
